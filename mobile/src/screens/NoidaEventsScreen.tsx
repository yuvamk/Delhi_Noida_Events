...
export default function NoidaEventsScreen({ navigation }: any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View>
          <Text style={styles.headerTitle}>🌆 Noida Events</Text>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyTitle}>No Noida events found</Text>
...
const styles = StyleSheet.create({
  ...
  priceChipActive: { backgroundColor: colors.tertiary + '33', borderColor: colors.tertiary },
  priceChipText: { color: colors.onSurfaceVariant, fontSize: 12, fontWeight: '600' },
  priceChipTextActive: { color: colors.tertiary, fontWeight: '800' },
