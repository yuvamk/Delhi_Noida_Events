    ...
    <div className="w-full max-w-[440px] mx-auto bg-surface-container/60 backdrop-blur-xl border border-white/5 rounded-2xl p-6 md:p-8 shadow-2xl">
      ...
      <div className="space-y-4">
         ...
         <div className="grid grid-cols-2 gap-3">
          <button onClick={loginWithGoogle} className="flex flex-col items-center justify-center gap-1 bg-surface-container border border-white/5 hover:border-white/20 transition-all duration-300 py-2.5 rounded-xl">
          ...
          <button className="flex flex-col items-center justify-center gap-1 bg-surface-container border border-white/5 hover:border-white/20 transition-all duration-300 py-2.5 rounded-xl">
